      ...
      <main className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-6 max-w-4xl mx-auto pt-20">
        ...
        >
          <input
            ...
            required
            className="flex-1 px-4 py-4 md:py-5 bg-black/40 border border-gray-500 rounded md:rounded-r-none focus:outline-none focus:ring-2 focus:ring-white text-lg"
          />
          <button 
            type="submit"
